...
module Core (
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.QNICE_CLK_I, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN Core_qnice_clk_i, INSERT_VIP 0" *)
  input qnice_clk_i;
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.HR_CLK_I, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN Core_hr_clk_i, INSERT_VIP 0" *)
  input hr_clk_i;
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_I, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN Core_clk_i, INSERT_VIP 0" *)
  input clk_i;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.MAIN_CLK_O CLK" *)
  (* X_INTERFACE_MODE = "master CLK.MAIN_CLK_O" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.MAIN_CLK_O, FREQ_HZ 54000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, INSERT_VIP 0" *)
  output main_clk_o;
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.IEC_CLK_N_I, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN Core_iec_clk_n_i, INSERT_VIP 0" *)
  input iec_clk_n_i;
