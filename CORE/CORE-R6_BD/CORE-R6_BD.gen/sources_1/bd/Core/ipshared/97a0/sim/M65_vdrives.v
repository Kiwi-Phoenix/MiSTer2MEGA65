...
module M65_vdrives
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_CORE_I CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_CORE_I, CLK_DOMAIN M65_vdrives_clk_core_i, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_core_i;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_QNICE_I CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_QNICE_I, CLK_DOMAIN M65_vdrives_clk_qnice_i, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_qnice_i;
  ...
  input qnice_ce_i;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.QNICE_DATA_I DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.QNICE_DATA_I, LAYERED_METADATA undef" *) input [15:0]qnice_data_i;
