...
module framework (
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_I, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN framework_clk_i, INSERT_VIP 0" *)
  input clk_i;
  ...
  output kb_io0_o;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.KB_IO1_O DATA" *)
  (* X_INTERFACE_MODE = "master DATA.KB_IO1_O" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.KB_IO1_O, LAYERED_METADATA undef" *)
  output kb_io1_o;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.KB_IO2_I DATA" *)
  (* X_INTERFACE_MODE = "slave DATA.KB_IO2_I" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.KB_IO2_I, LAYERED_METADATA undef" *)
  input kb_io2_i;
  (* X_INTERFACE_IGNORE = "true" *)
  output sd_reset_o;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.HR_D_IO DATA" *)
  (* X_INTERFACE_MODE = "slave DATA.HR_D_IO" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.HR_D_IO, LAYERED_METADATA undef" *)
  inout [7:0]hr_d_io;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.HR_RWDS_IO DATA" *)
  (* X_INTERFACE_MODE = "slave DATA.HR_RWDS_IO" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.HR_RWDS_IO, LAYERED_METADATA undef" *)
  inout hr_rwds_io;
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.MAIN_CLK_I, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN framework_main_clk_i, INSERT_VIP 0" *)
  input main_clk_i;
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.VIDEO_CLK_I, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN framework_video_clk_i, INSERT_VIP 0" *)
  input video_clk_i;
