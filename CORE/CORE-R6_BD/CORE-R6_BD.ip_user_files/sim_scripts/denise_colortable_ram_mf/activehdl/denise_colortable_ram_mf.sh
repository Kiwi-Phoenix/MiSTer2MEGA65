...
#                script (type 'denise_colortable_ram_mf.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Retro/Mega65/FPGA_Projects/Amiga-Core-Test/CORE/CORE-R6_BD/CORE-R6_BD.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
