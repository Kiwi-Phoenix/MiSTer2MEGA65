...
#
# Script generated by Vivado on Sat Mar 15 12:04:11 +1300 2025
# SW Build 5266912 on Sun Dec 15 09:03:24 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : denise_colortable_ram_mf.sh
...
#
# Usage        : denise_colortable_ram_mf.sh
#                denise_colortable_ram_mf.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                denise_colortable_ram_mf.sh [-reset_run]
#                denise_colortable_ram_mf.sh [-reset_log]
#                denise_colortable_ram_mf.sh [-help]
#
...
# script info
echo -e "denise_colortable_ram_mf.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./denise_colortable_ram_mf.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_10 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot denise_colortable_ram_mf xil_defaultlib.denise_colortable_ram_mf xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim denise_colortable_ram_mf -key {Behavioral:sim:Functional:denise_colortable_ram_mf} -tclbatch cmd.tcl -protoinst "protoinst_files/framework.protoinst" -protoinst "protoinst_files/Core.protoinst" -protoinst "protoinst_files/M65_vdrives.protoinst" -protoinst "protoinst_files/M65_Main.protoinst" -protoinst "protoinst_files/Amiga_EMU.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb denise_colortable_ram_mf.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./denise_colortable_ram_mf.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: denise_colortable_ram_mf.sh [-help]\n\
Usage: denise_colortable_ram_mf.sh [-step]\n\
Usage: denise_colortable_ram_mf.sh [-lib_map_path]\n\
Usage: denise_colortable_ram_mf.sh [-reset_run]\n\
Usage: denise_colortable_ram_mf.sh [-reset_log]\n\
Usage: denise_colortable_ram_mf.sh [-keep_index]\n\
Usage: denise_colortable_ram_mf.sh [-noclean_files]\n\n\
