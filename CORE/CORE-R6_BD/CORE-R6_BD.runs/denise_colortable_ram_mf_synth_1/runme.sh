...
HD_PWD='D:/Retro/Mega65/FPGA_Projects/Amiga-Core-Test/CORE/CORE-R6_BD/CORE-R6_BD.runs/denise_colortable_ram_mf_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log denise_colortable_ram_mf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source denise_colortable_ram_mf.tcl
