...
HD_PWD='D:/Retro/Mega65/FPGA_Projects/Amiga-Core-Test/CORE/CORE-R6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mega65_r6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mega65_r6.tcl
