...
//Date        : Sun Mar 16 14:35:25 2025
//Host        : Retro-PC running 64-bit major release  (build 9200)
//Command     : generate_target M65_Core.bd
//Design      : M65_Core
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "M65_Core,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=M65_Core,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=2,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "M65_Core.hwdef" *) 
module M65_Core
   (cart_a_i,
    cart_a_o,
    cart_addr_oe_o,
  ...
  input cart_rw_i;
  output cart_rw_o;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_I CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_I, CLK_DOMAIN M65_Core_clk_i, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk_i;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.HR_CLK_I CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.HR_CLK_I, CLK_DOMAIN M65_Core_hr_clk_i, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input hr_clk_i;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.IEC_CLK_N_I CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.IEC_CLK_N_I, CLK_DOMAIN M65_Core_iec_clk_n_i, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input iec_clk_n_i;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.MAIN_CLK_O CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.MAIN_CLK_O, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output main_clk_o;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.QNICE_CLK_I CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.QNICE_CLK_I, CLK_DOMAIN M65_Core_qnice_clk_i, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input qnice_clk_i;
  ...
  assign main_clk_o = video_clk_o;
  M65_Core_M65_Main_0_0 M65_Main_0
       (.audio_left_o(main_audio_left_o),
        .audio_right_o(main_audio_right_o),
        .clk_main_i(video_clk_o),
        ...
        .paddle_speed_i({1'b0,1'b0,1'b0,1'b0}),
  ...
  M65_Core_M65_vdrives_0_0 M65_vdrives_0
       (.clk_core_i(video_clk_o),
