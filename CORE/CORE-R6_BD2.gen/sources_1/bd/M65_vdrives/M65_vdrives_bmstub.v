...
module M65_vdrives (
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_QNICE_I, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN M65_vdrives_clk_qnice_i, INSERT_VIP 0" *)
  input clk_qnice_i;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK_CORE_I CLK" *)
  (* X_INTERFACE_MODE = "slave CLK.CLK_CORE_I" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK_CORE_I, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN M65_vdrives_clk_core_i, INSERT_VIP 0" *)
  input clk_core_i;
